...
namespace BLL.Authentication.Options
{
    /// <summary>
    /// Class to set JWT registered claim values (https://tools.ietf.org/html/rfc7519#section-4.1)
    /// And additional functionality to sign tokens upon creation.
    /// </summary>
    public class JwtIssuerOptions
    {
        ...
        /// An example is the user id of the user. The processing of this claim
